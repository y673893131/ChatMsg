...
//            qDebug() << msg;
            text.setHtml(msg);
            text.setTextWidth(m_textLeftRect.width());
            text.adjustSize();
            text.drawContents(painter/*, m_textLeftRect*/);
            painter->restore();
        }
    }
...
//        painter->drawText(m_textRightRect, msg, textOption);
        ...
        else
        {
            ...
            text.setTextWidth(m_textRightRect.width());
            text.adjustSize();
            text.drawContents(painter/*, m_textRightRect*/);
            painter->restore();
        }
        //send state
        if (state == Send_ing)
